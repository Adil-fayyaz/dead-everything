...
title = Hacker Reporter

# (str) Package name
package.name = hackerreporter

# (str) Package domain (needed for android/ios packaging)
package.domain = org.infinityx
...
source.exclude_dirs = tests, bin, .git, __pycache__, screenshots, logs, sessions, encrypted_credentials
...
requirements = python3,kivy,kivymd,colorama,requests,selenium,webdriver-manager,cryptography,PySocks,stem,pillow
